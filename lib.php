...
define('THROWQUESTIONS_LOBBYTABLE',321);
define('THROWQUESTIONS_SCORETABLE',320);
define('THROWQUESTIONS_BATTLEGROUNDTABLE',439);
define('THORWQUESTIONS_QUESTIONSTABLE',272);
